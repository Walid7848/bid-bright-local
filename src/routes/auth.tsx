...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [{ title: "تسجيل الدخول — مِهنتي" }],
  }),
  component: AuthPage,
});
      ...
      <div className="relative hidden overflow-hidden bg-gradient-hero p-12 lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="text-white">
          <h2 className="text-3xl font-bold leading-snug">
            انضم لآلاف الزبائن وأصحاب المهن في منصة واحدة
          </h2>
          <p className="mt-4 text-white/80">
            انشر طلبك، استقبل عروض تفاعلية، واختر الأنسب لك.
          </p>
        </div>
        <div className="text-xs text-white/60">© مِهنتي {new Date().getFullYear()}</div>
      </div>
      ...
      <div className="flex items-center justify-center p-6">
        <Card className="w-full max-w-md p-8 shadow-elegant">
          <div className="mb-6 flex items-center gap-2 lg:hidden">
            ...
            <span className="font-bold">مِهنتي</span>
          </div>
